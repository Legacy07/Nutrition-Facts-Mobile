...
public class Calorie_Breakdown {
    ...
    public double fatToCalories(double fat)
    {
    ...
    public double carbToCalories(double carb)
    {
    ...
    public double proteinToCalories(double protein)
    {
    ...
    public  double caloriesInFat(double fatCalories, double calories)
    {
    ...
    public  double caloriesInCarb(double carbCalories, double calories)
    {
